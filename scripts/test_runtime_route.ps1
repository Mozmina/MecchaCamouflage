...
Assert-True ($SourceText.Contains("uv_gap_fill_prepared")) "UV gap fill preparation marker is missing"
Assert-True ($SourceText.Contains("uv_gap_fill_enabled=1")) "UV gap fill enabled marker is missing"
Assert-True ($SourceText.Contains("uv_gap_fill_candidates=")) "UV gap fill candidates marker is missing"
Assert-True ($SourceText.Contains("uv_gap_fill_sent=")) "UV gap fill sent marker is missing"
Assert-True ($SourceText.Contains("uv_gap_fill_edge_extended=")) "UV gap fill edge extension marker is missing"
Assert-True ($SourceText.Contains("uv_gap_fill_coverage_before=")) "UV gap fill coverage-before marker is missing"
Assert-True ($SourceText.Contains("uv_gap_fill_coverage_after=")) "UV gap fill coverage-after marker is missing"
Assert-True (-not $SourceText.Contains("surface_stretch_enabled=1")) "failed surface-stretch experiment returned"
Assert-True (-not $SourceText.Contains("adaptive_resample_sent=")) "failed adaptive-resample experiment returned"
Assert-True (-not $SourceText.Contains("local_radius_inflation_used=")) "failed radius-inflation experiment returned"
