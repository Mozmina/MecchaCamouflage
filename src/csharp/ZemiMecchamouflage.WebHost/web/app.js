...
function renderSettings(snapshot) {
  ...
  setNumberPair("second-pass-brush-size", "second-pass-brush-size-number", paint.secondPassBrushSizeTexels);
  setNumberPair("second-pass-color-compression-tolerance", "second-pass-color-compression-tolerance-number", paint.secondPassColorCompressionTolerance);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  bindRangePair("second-pass-brush-size", "second-pass-brush-size-number", "paint.secondPassBrushSizeTexels");
  bindRangePair("second-pass-color-compression-tolerance", "second-pass-color-compression-tolerance-number", "paint.secondPassColorCompressionTolerance");
